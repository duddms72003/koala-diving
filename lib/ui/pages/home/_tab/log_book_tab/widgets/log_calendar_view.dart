...
class LogCalendarView extends StatefulWidget {
  final Function(DateTime) onDateSelected;
  final List<Map<String, String>> savedItems;

  const LogCalendarView({
    Key? key,
  ...
  @override
  State<LogCalendarView> createState() => _LogCalendarViewState();
}

class _LogCalendarViewState extends State<LogCalendarView> {
  ...
  @override
  void didUpdateWidget(LogCalendarView oldWidget) {
